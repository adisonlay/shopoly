...
import { Box, AppBar, Toolbar, Typography, Tooltip, IconButton, Badge } from '@material-ui/core';
  ...
  return (
    <Box mb="1rem">
      <AppBar position="static">
        <Toolbar>
          <Box width={1} display="flex" flexWrap="wrap" alignItems="center">

            <Box className="cursor" p="0.25rem" my="0.25rem" bgcolor="error.main" borderRadius="1rem" onClick={handleLogoClick}>
              <Box
                pl="1.25rem"
                pr="1rem"
                fontWeight={700}
            ...
            <Box alignSelf="flex-end" ml="0.5rem" mb="0.25rem">
